...
class AiderWorkerStub:
    ...
    def __init__(self, channel):
        ...
        self.Execute = channel.unary_unary(
                '/aider_worker.AiderWorker/Execute',
                request_serializer=worker__pb2.Contract.SerializeToString,
                response_deserializer=worker__pb2.Result.FromString,
                _registered_method=True)
        self.HealthCheck = channel.unary_unary(
                '/aider_worker.AiderWorker/HealthCheck',
...
def add_AiderWorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Execute': grpc.unary_unary_rpc_method_handler(
                    servicer.Execute,
                    request_deserializer=worker__pb2.Contract.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'aider_worker.AiderWorker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aider_worker.AiderWorker', rpc_method_handlers)
...
class AiderWorker:
    ...
    def Execute(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/aider_worker.AiderWorker/Execute',
            worker__pb2.Contract.SerializeToString,
