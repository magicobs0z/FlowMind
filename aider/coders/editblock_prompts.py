...
Only create *SEARCH/REPLACE* blocks for files that need to be modified or created.
When creating a new file, use an empty SEARCH section and put the new content in the REPLACE section.
