...
export default function ChatPanel() {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-white">
      {/* 顶部栏：标题 + 展开对话管理按钮 */}
      <div className="flex items-center justify-between px-3 py-2 border-b" style={{ borderColor: 'var(--flowmind-border)' }}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-xs text-gray-400">在上方输入你的问题或需求</p>
          </div>
        ) : (
          messages.map((msg) => (
            <div
            ...
            >
              {msg.role === 'user' ? (
                ...
                <div className="max-w-[85%] bg-red-50 border border-red-200 rounded-lg px-3 py-2">
